...
import { ProductReqListTable } from "./components/Table/ProductLReqListTable";
...
export const ProductReqListPage: React.FC = () => {
  ...
  const onSubmit = (values: ProductReqList) => {
    setFilters({
  ...
  return (
    ...
    >
      <section className="p-4 lg:p-8 xl:p-10">
        ...
        <div className="flex items-center justify-between">
          ...
          <NeumorphicButton
            ...
            variant="default"
            size="default"
            onClick={() => navigate("/asset/manageemnt/product-req-list/purchase-req")}
          >
     ...
     <ProductReqListTable filters ={filters}/>
      </section>
    </PageWrapper>
  );
};