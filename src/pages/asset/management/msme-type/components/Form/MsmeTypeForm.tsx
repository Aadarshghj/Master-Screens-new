...
interface MsmeTypeFormProps {
  control: Control<MsmeType>;
  errors: FieldErrors<MsmeType>;
  register: UseFormRegister<MsmeType>;
...
export const MsmeTypeForm: React.FC<MsmeTypeFormProps> = ({
  errors,
  control,
  register,
  isSubmitting,
        ...
        <div className="mt-2">
          ...
          <Flex.ActionGroup className="mt-2 justify-end gap-4">
            ...
            >
              ...
              {isSubmitting ? "Saving..." : "Save MSME Type"}
            </NeumorphicButton>
          </Flex.ActionGroup>
        </div>
      </Form>
