...
import { useContactTypeTable } from '../Hooks/useContactTypeTable';
import type { ContactType } from "../../../../../../types/asset-mgmt/contact-type";

const columnHelper = createColumnHelper<ContactType>();

export const ContactTypeTable: React.FC = () => {
  const { data, isFetching, onEdit } = useContactTypeTable();
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor("contactTypeDesc", {
        header: "Description",
      }),
