...
interface AssetCategoryFormProps {
  control: Control<AssetCategory>;
  errors: FieldErrors<AssetCategory>;
  register: UseFormRegister<AssetCategory>;
        ...
        <div className="mt-2">
          <Form.Row gap={10}>
            <Form.Col lg={3} md={6} span={12}>
              <Form.Field
                ...
                required
                error={errors.assetGroupCode}
              >
                <Input
                  {...register("assetGroupCode")}
                  readOnly
            ...
            <Form.Col lg={3} md={12} span={12}>
              <Form.Field label="Asset Category Description">
                <Textarea
                  {...register("assetCategoryDesc")}
          ...
          <Flex.ActionGroup className="mt-2 justify-end gap-4">
            ...
            >
              ...
              {isSubmitting ? "Saving..." : "Save Asset Category"}
            </NeumorphicButton>
          </Flex.ActionGroup>
        </div>
      </Form>
