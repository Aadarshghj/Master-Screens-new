...
export const AssetCategoryTable: React.FC = () => {
  const { data, isFetching, onEdit } = useAssetCategoryTable();
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor("assetGroupCode", {
        header: "Asset Group Code",
      }),

      columnHelper.accessor("assetCategoryName", {
        header: "Asset Category Name",
      }),

      columnHelper.accessor("assetCategoryDesc", {
        header: "Asset Category Description",
      }),
