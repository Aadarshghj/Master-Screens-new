...
import { DesignationDetailsTable } from "./components/Table/DesignationTable";
...
export const DesignationPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <section className="p-4 lg:p-8 xl:p-10">
          ...
          <div className="flex items-center justify-between">
            <TitleHeader title="Designation" className="py-4" />
            <NeumorphicButton
              type="button"
              variant="default"
              size="default"
      ...
      >
        <section className="p-4 lg:p-8 xl:p-10">
          <TitleHeader className="pb-4" title="List of Designations" />
          <DesignationDetailsTable occupationOptions={occupationOptions} />
        </section>
      </PageWrapper>
    </div>
  );
