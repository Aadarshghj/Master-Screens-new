...
import { useDocumentType } from "./components/Hooks/useDocumentType";
import { DocumentTypeForm } from "./components/Form/DocumentTypeForm";
import { DocumentTypeTable } from "./components/Table/DocumentTypeTable";
...
export const DocumentTypePage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <section className="p-4 lg:p-8 xl:p-10">
          ...
          <div className="flex items-center justify-between">
            <TitleHeader title="Document Type" className="py-4" />
            <NeumorphicButton
              type="button"
              variant="default"
              size="default"
      ...
      >
        <section className="p-4 lg:p-8 xl:p-10">
          <TitleHeader className="pb-4" title="List of Documents Type" />
          <DocumentTypeTable />
        </section>
      </PageWrapper>
    </div>
