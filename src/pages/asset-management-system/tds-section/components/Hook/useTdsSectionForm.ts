...
import type { TdsSectionRequestDto, TdsSectionTypes } from "@/types/asset-management-system/tds-section";
import { TDS_SECTION_DEFAULT_VALUES } from "../../constants/TdsSectionDefault";
import { tdsSectionSchema } from "@/global/validation/asset-management-system/tds-section";
