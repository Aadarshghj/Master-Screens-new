        ...
        <div className="flex justify-end gap-3 border-t border-slate-200 bg-white p-2">
          <button
            ...
            className={cn(
              ...
              pendingCount === 0 &&
                "cursor-not-allowed border-slate-200 bg-slate-100 text-slate-400 opacity-50 hover:bg-slate-100 hover:text-slate-400"
            )}
          >
    ...
    >
      {isLoading ? (
        <div className="flex h-40 flex-col items-center justify-center text-sm text-slate-400">
          <Loader2 size={32} className="mb-2 animate-spin text-blue-500" />
