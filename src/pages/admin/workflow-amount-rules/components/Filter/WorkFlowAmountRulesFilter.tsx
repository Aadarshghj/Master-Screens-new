...
import type { WorkflowAmountRulesFilterBarProps } from "@/types/admin/amountrules";

export const WorkflowAmountRulesFilterBar: React.FC<
  WorkflowAmountRulesFilterBarProps
> = ({ workflowOptions, selectedWorkflow, onFilterApply }) => {
